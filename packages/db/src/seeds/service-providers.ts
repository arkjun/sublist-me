...
export const serviceProviderSeeds: ServiceProviderSeed[] = [
  ...
  },
  {
    ...
    logoUrl: 'https://cnbl-cdn.bamgrid.com/assets/7ecc8bcb60ad77193058d63e321bd21cbac2fc67281dbd9927571f8fcb51a7a7/original',
    categories: ['ott'],
  },
  {
  ...
  },
  {
    ...
    logoUrl: 'https://assets.nintendo.com/image/upload/f_auto/q_auto/c_fill,w_800/ncom/en_US/switch/online-service/posters/nso-logo',
    categories: ['gaming'],
  },
  {
    slug: 'ea-play',
    ...
    logoUrl: 'https://media.contentapi.ea.com/content/dam/eacom/subscription/ea-play/common/embed-code/color/ea-play-logo-coral-embed-code.svg',
    categories: ['gaming'],
  },
  {
    slug: 'geforce-now',
    ...
    logoUrl: 'https://www.nvidia.com/content/dam/en-zz/Solutions/geforce/geforce-now/gfn-ultimate-ecosystem-text-nv-gf-wmfg-2560-d.jpg',
  ...
  },
  {
    ...
    logoUrl: 'https://cfl.dropboxstatic.com/static/metaserver/static/images/logo_catalog/dropbox_opengraph_image@2x-vflwsK445.png',
    categories: ['productivity', 'cloud'],
  },
  {
    slug: 'evernote',
  ...
  // ========== News ==========
  {
    ...
    logoUrl: 'https://www.nytimes.com/vi-assets/static-assets/apple-touch-icon-28865b72953380a40aa43318108876cb.png',
    categories: ['news'],
  },
  {
    slug: 'wsj',
  ...
  // ========== Fitness ==========
  {
    ...
    logoUrl: 'https://www.apple.com/v/apple-fitness-plus/ac/images/meta/apple-fitness-plus__cidrqiun6tle_og.png',
    categories: ['fitness'],
  },
  {
    slug: 'peloton',
  ...
  // ========== Education ==========
  {
    ...
    logoUrl: 'https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/https://coursera.s3.amazonaws.com/media/coursera-rebrand-logo-square.png',
